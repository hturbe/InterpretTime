...
# ==============================================================================
import sys
from petastorm.pytorch import  InMemBatchedDataLoader
sys.path.append("..")
from custom_reader import BatchedDataLoader
...
class PytorchDataLoader(BaseDataLoader):
    def __init__(self, reader, batch_size, shuffling_queue_capacity, name="",
                 limit_step_per_epoch=-1, verbose=False, desired_fields=None):
        self.reader = reader
...
class PytorchInfiniteDataLoader(PytorchDataLoader):
    def __init__(self, *args, **kwargs):
        ...
        self.data_loader = BatchedDataLoader(
            self.reader,
            batch_size=self.batch_size,
            desired_fields= kwargs["desired_fields"],
            shuffling_queue_capacity=self.shuffling_queue_capacity)
